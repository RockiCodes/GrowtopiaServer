...
void webhook(std::string username, std::string title, std::string desc) {
    ...
    std::string request_body = "{\"username\": \"" + username + "\",\"content\": null,\"embeds\": [{\"title\": \"" + title + "\",\"description\": \"" + desc + "\",\"footer\": {\"text\": \"RubyTopia Logs\"},\"color\": " + color + " }], \"attachments\": []}";
